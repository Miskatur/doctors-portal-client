...
const MakeAppointment = () => {
    return (
        <section className='mt-20 lg:mt-64 mb-32 bg-no-repeat bg-cover max-w-screen' style={{ backgroundImage: `url(${banner})` }}>
            <div className='grid md:grid-cols-2 pl-5'>
                ...
                <div className='flex flex-col justify-center items-center'>
                    <div className='py-10'>
                        ...
                        <Link to={'/appointment'}><CustomButton>Get an Appointment</CustomButton></Link>
                    </div>
                </div>
            </div>
        </section>
